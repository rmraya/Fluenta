...
public class AboutBox {
	...
	public AboutBox(Shell parent, int style) {
		...
		systemTab.setText(Messages.getString("AboutBox.2"));
		...
		MessageFormat mf3 = new MessageFormat(Messages.getString("AboutBox.3"));
		...
		MessageFormat mf1 = new MessageFormat(Messages.getString("AboutBox.4"));
		java1.setText(
		...
		MessageFormat mfox = new MessageFormat(Messages.getString("AboutBox.5"));
		...
		MessageFormat mfxml = new MessageFormat(Messages.getString("AboutBox.6"));
		...
		MessageFormat mfsw = new MessageFormat(Messages.getString("AboutBox.7"));
		...
		MessageFormat mfswt = new MessageFormat(Messages.getString("AboutBox.8"));
		swtLabel.setText(mfswt.format(new String[] { SWT.getPlatform(), "" + SWT.getVersion() }));

		Label java2 = new Label(info, SWT.NONE);
		MessageFormat mf2 = new MessageFormat(Messages.getString("AboutBox.9"));
		...
		licensesTab.setText(Messages.getString("AboutBox.10"));
		...
		try {
			...
			logger.log(Level.WARNING, Messages.getString("AboutBox.11"), e);
		}
