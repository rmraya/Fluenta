...
public class AboutBox {
	...
	public AboutBox(Shell parent, int style) {
		...
		java1.setText(mf1.format(new Object[]{System.getProperty("java.version"),System.getProperty("java.vendor")}));   //$NON-NLS-1$ //$NON-NLS-2$
		...
		javaLink.setText("Oracle Binary Code License Agreement"); //$NON-NLS-1$
		try {
